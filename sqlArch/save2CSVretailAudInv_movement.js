...
module.exports = {
  ...
  save2CSVretailAudInv_movement: router.post('/save2CSVretailAudInv_movement', (req, res, next) => {
    ...
    const fields = [
      "upc", "name", "ytd", "dept", "retailDiffOldTable_retail", "retailDiffNewTable_charm", "pct0", "plusPctg0to5", "minusPctg0to5", "plusPctg5to10",
      "minusPctg5to10", "plusPctg10to15", "minusPctg10to15", "plusPctg15to20", "minusPctg15to20", "plusPctg20to25", "minusPctg20to25", "plusPctg25to30",
      "minusPctg25to30", "plusPctg30to35", "minusPctg30to35", "plusPctg35to40", "minusPctg35to40", "plusPctg40to45", "minusPctg40to45", "plusPctg45to50",
      "minusPctg45to50", "plusPctg50plus", "minusPctg50plus"
    ];
    const opts = {
      fields
    };
